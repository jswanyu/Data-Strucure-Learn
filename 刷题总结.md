...
* length——数组的属性；length()——String的方法；size()——集合的方法；第二和第三底层都是数组的length属性

* 字符转为整型，只需要减去'0'。'2' 转为 整型2 只需要 '2'-'0' 即可
* Integer.parseInt() 查一下具体用法
...
![image.png](https://jswanyu-1309100582.cos.ap-shanghai.myqcloud.com/picgo/leetcode-17-%E5%9B%BE%E8%A7%A3.png)
...
![image.png](https://jswanyu-1309100582.cos.ap-shanghai.myqcloud.com/picgo/leetcode-93-%E5%9B%BE%E8%A7%A31.png)
...
![image.png](https://jswanyu-1309100582.cos.ap-shanghai.myqcloud.com/picgo/leetcode-93-%E5%9B%BE%E8%A7%A32.png)
